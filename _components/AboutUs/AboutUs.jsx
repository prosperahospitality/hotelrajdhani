...
const AboutUs = () => {
    return (
      <div className="w-[95%] mx-auto h-full lg:h-52 bg-gray-100 flex flex-col lg:flex-row ">
        <div className="bg-green-900 p-5 flex justify-center items-center w-full lg:w-[10%] relative">
          <div
            className={`absolute w-5 h-5 transform rotate-45 bg-green-900 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8 p-5 place-content-center w-full lg:w-[90%] mt-5 lg:m-0">
          <div className="grid grid-cols-2 gap-3 py-4  text-green-800 border-b-1 lg:border-b-0 lg:border-r-1 border-green-800">
            <h3 className="text-3xl text-start lg:text-center font-bold"> 20+</h3>
            <p className="text-start font-medium">Years of Experience</p>
          </div>
          <div className="grid grid-cols-3 gap-3 py-4  text-green-800  border-b-1 lg:border-b-0 lg:border-r-1 border-green-800">
          ...
          <div className="grid grid-cols-3 gap-3 py-4  text-green-800 border-b-1 md:border-b-0 lg:border-b-0 lg:border-r-1 border-green-800">
          ...
          <div className="grid grid-cols-3 gap-3 py-4  text-green-800">
