    ...
    const reviews = [
        {
            ...
            description:
                "Experience the serenity of Pavagadh with a comfortable stay at Hotel Rajdhani. Clean rooms and friendly staff make it an ideal choice for travelers.",
            name: "Rohit Mehta",
            gender: "Male",
            img: IMAGES.profile,
        },
        ...
        },
        {
            ...
            description:
                "Hotel Rajdhani serves as the perfect base for exploring Pavagadh. With basic amenities and a prime location, it's a good value for money.",
            name: "Vikram Desai",
            gender: "Male",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "The staff at Hotel Rajdhani went above and beyond to make our stay memorable. Comfortable rooms and delicious local food were the highlights.",
            name: "Nisha Sharma",
            gender: "Female",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "Hotel Rajdhani is an excellent choice for budget-conscious travelers. Its proximity to Pavagadh attractions is a big plus.",
            name: "Arjun Varma",
            gender: "Male",
            img: IMAGES.profile,
        },
        ...
        },
        {
            ...
            description:
                "Located near the main attractions, Hotel Rajdhani provides excellent hospitality. The staff ensured a comfortable and pleasant stay.",
            name: "Kunal Joshi",
            gender: "Male",
            img: IMAGES.profile,
        },
        ...
        <div className="bg-gray-100">
            <div className="flex flex-col gap-8 lg:gap-10 justify-center items-center py-20 w-[95%] mx-auto">
                ...
                <p className="text-base lg:text-lg lg:w-[80%] text-center">
                    Hear the glowing stories and testimonials from guests who’ve experienced the unmatched hospitality and comfort of Hotel Rajdhani!
                </p>
