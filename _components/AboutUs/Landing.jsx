  ...
  return (
    <div className="relative w-full h-[38rem]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-600 drop-shadow-2xl z-20 font-serif mb-8">
        <span className="text-5xl bg-black text-gray-100 p-2 rounded-lg px-4 bg-opacity-30">About Us</span>
        <span className="text-2xl bg-black text-gray-100 mt-4 p-2 rounded-lg px-4 bg-opacity-30">Discover the story of Hotel Rajdhani and experience the perfect blend of tradition, luxury, and exceptional hospitality.</span>
      </div>
      ...
      <div className="relative w-full h-full flex justify-center items-center bg-black opacity-95">
        ...
        <Image src={IMAGES.aboutuslanding} alt="landing-bg" fill className="object-cover" />
