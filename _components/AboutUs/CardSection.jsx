    ...
    const cardData = [
        {
            ...
            description:
                "Hotel Rajdhani offers a tranquil retreat with clean, comfortable rooms and exceptional service, making your stay near Pavagadh unforgettable.",
        ...
        },
        {
            ...
            description:
                "Conveniently located near Pavagadh's attractions, Hotel Rajdhani is the perfect base for exploring the area's cultural and natural wonders.",
            ...
            <div className="flex justify-center items-center w-[95%] mx-auto gap-10 my-32 lg:my-16">
                <div className="flex justify-center items-center flex-col gap-10 w-full ">
                    ...
                    <p className="text-gray-500 w-full lg:w-[50%] text-center">
                        ...
                        At Hotel Rajdhani, we strive to be your one-stop destination for a comfortable stay near Pavagadh. With our experience and dedication to hospitality, you can trust us to make your visit hassle-free and enjoyable.
                    </p>
