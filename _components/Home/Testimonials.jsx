    ...
    const testimonials = [
        {
            ...
            text: 'I had a fantastic stay at Hotel Rajdhani! The staff were incredibly welcoming and attentive, and the room was very clean and comfortable. The food was delicious, and the location was perfect for exploring the area. I highly recommend it to anyone looking for a relaxing getaway.',
        },
        {
            name: 'Manish D.',
            title: 'Gujarat',
            rating: 5,
            image: IMAGES.profile,
            text: 'Our stay at Hotel Rajdhani was amazing! The hotel is very family-friendly, with spacious rooms and a relaxed atmosphere. The kids enjoyed the pool, and the staff were always so accommodating. We especially loved the traditional Indian breakfast. A great place for a family retreat!',
        },
        {
            name: 'Neha P.',
            title: 'Lucknow',
            rating: 4,
            image: IMAGES.profile,
            text: 'The service at Hotel Rajdhani was top-notch! From the warm welcome at check-in to the attentive staff throughout our stay, every moment was special. The location is very convenient for exploring the city, and the food was delicious, especially the Indian delicacies. Will definitely return!',
        },
        {
            name: 'Madhuri R.',
            title: 'Mumbai',
            rating: 5,
            image: IMAGES.profile,
            text: 'I stayed at Hotel Rajdhani during a visit to Delhi, and it exceeded my expectations. The rooms were clean and well-equipped, and the staff was extremely helpful. The best part was the food – authentic and flavorful North Indian dishes. It’s great value for the price!',
        },
