...
const Placestovisit = () => {
  return (
    <div className="w-screen h-auto bg-white text-black pt-10 lg:pt-0">
      <div className="w-[95%] mx-auto">
        {/* Mobile View */}
        <div className="w-[90%] lg:hidden grid grid-cols-1 mt-14 mx-auto gap-10">
          <div>
          ...
          {OurProcessData.map((item) => (
            <div key={item.id} className="mb-12">
              ...
              <div className="text-left mt-6">
                <h1 className="text-xl font-semibold leading-relaxed  border-l-3 border-blue-600 pl-3">
                  {item.title}
                </h1>
