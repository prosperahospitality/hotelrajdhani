...
const Facilities = () => {
    const data = [
        {
            id: 1,
            svg: <Parking className="w-[25px] h-[25px] " />,
            heading: "Parking",
            para: "Convenient onsite parking available for guests. ",
        },
        {
            id: 2,
            svg: <Cctv className="w-[25px] h-[25px] text-green-500" />,
        ...
        {
            id: 3,
            svg: <Droplets className="w-[25px] h-[25px] text-green-500" />,
                    ...
                    <div className=" mt-2 w-full lg:w-[95%] gap-10 p-5 grid grid-cols-1 md:grid-cols-4  place-items-center xl:mt-8 ">
                        {data &&
                            data?.map((e, i) => (
                                ...
                                >
                                    <div className="flex justify-center items-center">
                                        <div className="size-[60px] rounded-full flex justify-center items-center bg-primary/20">
                                            {e.svg}
                                        </div>
                                    </div>
